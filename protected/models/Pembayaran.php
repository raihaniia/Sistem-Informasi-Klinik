...
class Pembayaran extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('jumlah_obat, harga_obat, total_harga', 'required'),
			array('jumlah_obat', 'numerical', 'integerOnly'=>true),
			array('harga_obat, total_harga', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_pasien, jumlah_obat, harga_obat, total_harga', 'safe', 'on'=>'search'),
		);
	}
